...
export function AboutSection() {
  ...
  const aiTools = ["PyTorch", "TensorFlow", "Keras", "Scikit-learn", "Hugging Face", "LangChain", "ONNX", "OpenCV"];
      ...
      <div className="container">
        ...
        <div className="mt-24">
          ...
          <div className="grid gap-8 md:grid-cols-4">
            ...
            <div className="bg-black/80 p-6 rounded-lg border border-purple-800/30 hover:shadow-lg transition-all opacity-0 animate-on-scroll" style={{ animationDelay: "300ms" }}>
              <div className="flex items-center gap-3 mb-4">
                <Database className="h-6 w-6 text-purple-400" />
                <h3 className="text-xl font-semibold text-white">AI Stack</h3>
              </div>
              <div className="flex flex-wrap gap-2">
